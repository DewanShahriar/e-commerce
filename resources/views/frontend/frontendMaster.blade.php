...
<!-- Mirrored from lionsbite.xyz//html/hakduck-preview/ by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 23 Jun 2021 11:54:30 GMT -->
<head>
	<meta charset="utf-8">
	<meta http-equiv="x-ua-compatible" content="ie=edge">
	<title>HakDuck - Home One</title>
	...
	<!-- elegant css -->
	<link rel="stylesheet" href="{{ asset('/')}}frontendAssets/css/elegant.css">
	<!-- elegant css -->
	<link rel="stylesheet" href="{{ asset('/')}}frontendAssets/css/jquery.mmenu.css">
	<!-- jquery-ui.min css -->
	<link rel="stylesheet" href="{{ asset('/')}}frontendAssets/css/jquery-ui.min.css">
	<!-- perfect-scrollbar css -->
	<link rel="stylesheet" href="{{ asset('/')}}frontendAssets/css/perfect-scrollbar.css">
	<!-- venobox css -->
	<link rel="stylesheet" href="{{ asset('/')}}frontendAssets/css/venobox.css">
	<!-- slick css -->
	...
	<!-- cssanimation css -->
	<link rel="stylesheet" href="{{ asset('/')}}frontendAssets/css/cssanimation.min.css" />
	<!-- animate css -->
	<link rel="stylesheet" href="{{ asset('/')}}frontendAssets/css/animate.css" />	
	<!-- helper css -->
	<link rel="stylesheet" href="{{ asset('/')}}frontendAssets/css/helper.css">
	<!-- style css -->
						...
						<div class="col-lg-6">
							<div class="topbar-right">
								...
								<div class="currency-bar lang-bar pull-right">
									<ul>
										<li><a href="#"><img src="{{ asset('/')}}frontendAssets/images/icons/gb.png" alt="" />English <i class="fa fa-angle-down"></i></a>
											<ul>
			...
			<div class="sticker header-bottom">
				<div class="container-fluid">
					<div class="row align-items-center">
						<div class="col-lg-2">
							<div class="logo">
								<a href="index-2.html"><img src="{{ asset('/')}}frontendAssets/images/logo.png" alt="logo" /></a>
							</div>
						</div>
						<div class="col-lg-8">
							<div class="mainmenu">  
											...
											<ul>
												<li>
													<div class="mini-cart-thumb">
														<a href="#"><img src="{{ asset('/')}}frontendAssets/images/products/cart/thumb-1.jpg" alt="" /></a>
													</div>
												...
												<li>
													<div class="mini-cart-thumb">
														<a href="#"><img src="{{ asset('/')}}frontendAssets/images/products/cart/thumb-2.jpg" alt="" /></a>
													</div>
													<div class="mini-cart-heading">
														<span>$460.00 x 1</span>
														<h5><a href="#">Kabino Bedside Table</a></h5>
			...
			<div class="row">
				<div class="col-xl-6 offset-xl-2">
					<div class="main-slider mt-30 mt-sm-0">
						<div class="slider-single bg-1" style="background-image:url(frontendAssets/images/sliders/2.jpg)">
							<div class="d-table">
						...
						<div class="slider-single bg-2" style="background-image:url(frontendAssets/images/sliders/1.jpg)">
							<div class="d-table">
								<div class="slider-caption" >
									<h4>clothing</h4>
					...
					<div class="row mt-30">
						<div class="col-lg-6 col-sm-6 pl-05">
							<div class="banner-sm hover-effect">
								<img src="{{ asset('/')}}frontendAssets/images/banners/small/1.jpg" alt="" />
						...
						<div class="col-lg-6 col-sm-6 pl-05">
							<div class="banner-sm hover-effect mt-sm-20">
								<img src="{{ asset('/')}}frontendAssets/images/banners/small/2.jpg" alt="" />
								<div class="banner-info">
									<h4>Tech</h4>
						...
						<div class="col-lg-6 col-sm-6 pl-05">
							<div class="banner-sm hover-effect mt-20">
								<img src="{{ asset('/')}}frontendAssets/images/banners/small/3.jpg" alt="" />
								<div class="banner-info">
									<h4>Beauty</h4>
						...
						<div class="col-lg-6 col-sm-6 pl-05">
							<div class="banner-sm hover-effect mt-20">
								<img src="{{ asset('/')}}frontendAssets/images/banners/small/4.jpg" alt="" />
								<div class="banner-info">
									<h4>Electronics</h4>
				...
				<div class="col-xl-2 col-lg-3">
					<div class="sidebar">
							...
							<div class="row product-deals">
								...
								<div class="col-lg-12">
									<div class="product-single product-deal">
										...
										<div class="product-thumb">
											<a href="#"><img src="{{ asset('/')}}frontendAssets/images/products/deals/1.jpg" alt="" /></a>
								...
								<div class="col-lg-12">
									<div class="product-single product-deal">
										...
										<div class="product-thumb">
											<a href="#"><img src="{{ asset('/')}}frontendAssets/images/products/1.jpg" alt="" /></a>
											<div class="downsale"><span>-</span>$25</div>
											<div class="product-quick-view">
												<a href="javascript:void(0);" data-toggle="modal" data-target="#quick-view">quick view</a>
											</div>
								...
								<div class="col-lg-12">
									<div class="product-single product-deal">
										...
										<div class="product-thumb">
											<a href="#"><img src="{{ asset('/')}}frontendAssets/images/products/3.jpg" alt="" /></a>
											<div class="downsale"><span>-</span>$25</div>
											<div class="product-quick-view">
												<a href="javascript:void(0);" data-toggle="modal" data-target="#quick-view">quick view</a>
											</div>
								...
								<div class="col-lg-12">
									<div class="product-single product-deal">
										...
										<div class="product-thumb">
											<a href="#"><img src="{{ asset('/')}}frontendAssets/images/products/4.jpg" alt="" /></a>
											<div class="downsale"><span>-</span>$25</div>
											<div class="product-quick-view">
												<a href="javascript:void(0);" data-toggle="modal" data-target="#quick-view">quick view</a>
											</div>
						...
						<div class="sidebar-single mt-30 d-none d-xl-block">
							<a href="#"><img src="{{ asset('/')}}frontendAssets/images/ad/1.jpg" alt="" /></a>
						</div>
						<!--latest-products-->
											...
											<div class="product-single style-2">
												<div class="row align-items-center m-0">
													<div class="col-lg-4 p-0">
														<div class="product-thumb">
															<a href="#"><img src="{{ asset('/')}}frontendAssets/images/products/latest/1.jpg" alt="" /></a>
														</div>
													</div>
										...
										<li>
											<div class="product-single style-2">
												<div class="row align-items-center m-0">
													<div class="col-lg-4 p-0">
														<div class="product-thumb">
															<a href="#"><img src="{{ asset('/')}}frontendAssets/images/products/latest/2.jpg" alt="" /></a>
														</div>
													</div>
													<div class="col-lg-8 p-0">
														<div class="product-title">
										...
										<li>
											<div class="product-single style-2">
												<div class="row align-items-center m-0">
													<div class="col-lg-4 p-0">
														<div class="product-thumb">
															<a href="#"><img src="{{ asset('/')}}frontendAssets/images/products/latest/3.jpg" alt="" /></a>
														</div>
													</div>
													<div class="col-lg-8 p-0">
														<div class="product-title">
										...
										<li>
											<div class="product-single style-2">
												<div class="row align-items-center m-0">
													<div class="col-lg-4 p-0">
														<div class="product-thumb">
															<a href="#"><img src="{{ asset('/')}}frontendAssets/images/products/latest/4.jpg" alt="" /></a>
														</div>
													</div>
													<div class="col-lg-8 p-0">
														<div class="product-title">
										...
										<li>
											<div class="product-single style-2">
												<div class="row align-items-center m-0">
													<div class="col-lg-4 p-0">
														<div class="product-thumb">
															<a href="#"><img src="{{ asset('/')}}frontendAssets/images/products/latest/5.jpg" alt="" /></a>
														</div>
													</div>
													<div class="col-lg-8 p-0">
														<div class="product-title">
								...
								<ul class="list-none">
									<li>
										<div class="support-icon">
											<img src="{{ asset('/')}}frontendAssets/images/icons/bank-loan.jpg" alt="" />
										</div>
									...
									<li>
										<div class="support-icon">
											<img src="{{ asset('/')}}frontendAssets/images/icons/bank-liquidity.jpg" alt="" />
										</div>
										<div class="support-text">
									...
									<li>
										<div class="support-icon">
											<img src="{{ asset('/')}}frontendAssets/images/icons/bank-credit-card.jpg" alt="" />
										</div>
										<div class="support-text">
									...
									<li>
										<div class="support-icon">
											<img src="{{ asset('/')}}frontendAssets/images/icons/bank-support.jpg" alt="" />
										</div>
										<div class="support-text">
				...
				<div class="col-xl-10 col-lg-9 fix">
						...
						<div class="row product-categories-carousel mt-30">
							<div class="col-lg-3">
								<div class="single-product-cat">
									<a href="#"><img src="{{ asset('/')}}frontendAssets/images/products/category/1.png" alt="" /></a>
									<h4><a href="#">Sports & Outdoors</a></h4>
								</div>
							</div>
							<div class="col-lg-3">
								<div class="single-product-cat">
									<a href="#"><img src="{{ asset('/')}}frontendAssets/images/products/category/2.png" alt="" /></a>
									<h4><a href="#">Headphones</a></h4>
								</div>
							</div>
							<div class="col-lg-3">
								<div class="single-product-cat">
									<a href="#"><img src="{{ asset('/')}}frontendAssets/images/products/category/3.png" alt="" /></a>
									<h4><a href="#">Smart phone & Tablets</a></h4>
								</div>
							</div>
							<div class="col-lg-3">
								<div class="single-product-cat">
									<a href="#"><img src="{{ asset('/')}}frontendAssets/images/products/category/4.png" alt="" /></a>
								...
								<div class="row product-carousel cv-visible">
									<div class="col-lg-3">
										...
										<div class="product-single">
											...
											<div class="product-thumb">
												<a href="#"><img src="{{ asset('/')}}frontendAssets/images/products/2.jpg" alt="" /></a>
												<div class="downsale"><span>-</span>$25</div>
												<div class="product-quick-view">
													<a href="javascript:void(0);" data-toggle="modal" data-target="#quick-view">quick view</a>
												</div>
									...
									<div class="col-lg-3">
										...
										<div class="product-single">
											...
											<div class="product-thumb">
												<a href="#"><img src="{{ asset('/')}}frontendAssets/images/products/5.jpg" alt="" /></a>
												<div class="product-quick-view">
													<a href="javascript:void(0);" data-toggle="modal" data-target="#quick-view">quick view</a>
												</div>
											</div>
										...
										<div class="product-single">
											...
											<div class="product-thumb">
												<a href="#"><img src="{{ asset('/')}}frontendAssets/images/products/6.jpg" alt="" /></a>
												<div class="product-quick-view">
													<a href="javascript:void(0);" data-toggle="modal" data-target="#quick-view">quick view</a>
												</div>
											</div>
									...
									<div class="col-lg-3">
										...
										<div class="product-single">
											...
											<div class="product-thumb">
												<a href="#"><img src="{{ asset('/')}}frontendAssets/images/products/7.jpg" alt="" /></a>
												<div class="product-quick-view">
													<a href="javascript:void(0);" data-toggle="modal" data-target="#quick-view">quick view</a>
												</div>
											</div>
										...
										<div class="product-single">
											...
											<div class="product-thumb">
												<a href="#"><img src="{{ asset('/')}}frontendAssets/images/products/8.jpg" alt="" /></a>
												<div class="product-quick-view">
													<a href="javascript:void(0);" data-toggle="modal" data-target="#quick-view">quick view</a>
												</div>
											</div>
								...
								<div class="row product-carousel cv-visible">
									...
									<div class="col-lg-3">
										...
										<div class="product-single">
											...
											<div class="product-thumb">
												<a href="#"><img src="{{ asset('/')}}frontendAssets/images/products/shop/7.jpg" alt="" /></a>
												<div class="product-quick-view">
													<a href="javascript:void(0);" data-toggle="modal" data-target="#quick-view">quick view</a>
												</div>
											</div>
										...
										<div class="product-single">
											...
											<div class="product-thumb">
												<a href="#"><img src="{{ asset('/')}}frontendAssets/images/products/shop/8.jpg" alt="" /></a>
												<div class="product-quick-view">
													<a href="javascript:void(0);" data-toggle="modal" data-target="#quick-view">quick view</a>
												</div>
											</div>
						...
						<div class="row best-seller cv-visible">
							<div class="col-lg-3">
								<div class="product-single">
									...
									<div class="product-thumb">
										<a href="#"><img src="{{ asset('/')}}frontendAssets/images/products/9.jpg" alt="" /></a>
										<div class="downsale"><span>-</span>$25</div>
										<div class="product-quick-view">
											<a href="javascript:void(0);" data-toggle="modal" data-target="#quick-view">quick view</a>
										</div>
							...
							<div class="col-lg-3">
								<div class="product-single">
									...
									<div class="product-thumb">
										<a href="#"><img src="{{ asset('/')}}frontendAssets/images/products/10.jpg" alt="" /></a>
										<div class="product-quick-view">
											<a href="javascript:void(0);" data-toggle="modal" data-target="#quick-view">quick view</a>
										</div>
									</div>
							...
							<div class="col-lg-3">
								<div class="product-single">
									...
									<div class="product-thumb">
										<a href="#"><img src="{{ asset('/')}}frontendAssets/images/products/11.jpg" alt="" /></a>
										<div class="product-quick-view">
											<a href="javascript:void(0);" data-toggle="modal" data-target="#quick-view">quick view</a>
										</div>
									</div>
							...
							<div class="col-lg-3">
								<div class="product-single">
									...
									<div class="product-thumb">
										<a href="#"><img src="{{ asset('/')}}frontendAssets/images/products/12.jpg" alt="" /></a>
										<div class="product-quick-view">
											<a href="javascript:void(0);" data-toggle="modal" data-target="#quick-view">quick view</a>
										</div>
									</div>
							...
							<div class="col-lg-3">
								<div class="product-single">
									...
									<div class="product-thumb">
										<a href="#"><img src="{{ asset('/')}}frontendAssets/images/products/13.jpg" alt="" /></a>
										<div class="downsale"><span>-</span>$25</div>
										<div class="product-quick-view">
											<a href="javascript:void(0);" data-toggle="modal" data-target="#quick-view">quick view</a>
										</div>
					...
					<div class="row mt-40">
						<div class="col-xl-4 col-lg-6">
							<div class="banner-sm hover-effect">
								<img src="{{ asset('/')}}frontendAssets/images/banners/md/1.jpg" alt="" />
								<div class="banner-info">
						...
						<div class="col-xl-4 col-lg-6 mt-sm-30">
							<div class="banner-sm hover-effect">
								<img src="{{ asset('/')}}frontendAssets/images/banners/md/2.jpg" alt="" />
								<div class="banner-info">
									<div class="product-value">
										<span>$345.00</span>
										<del>$429.99</del>
						...
						<div class="col-xl-4 col-lg-6 d-none d-xl-block">
							<div class="banner-sm hover-effect">
								<img src="{{ asset('/')}}frontendAssets/images/banners/md/3.jpg" alt="" />
								<div class="banner-info">
									<div class="product-value">
										<span>$345.00</span>
										<del>$429.99</del>
					...
					<div class="row product-carousel-fullwidth cv-visible">
						<div class="col-lg-3">
							<div class="product-single">
								...
								<div class="product-thumb">
									<a href="#"><img src="{{ asset('/')}}frontendAssets/images/products/14.jpg" alt="" /></a>
									<div class="downsale"><span>-</span>$25</div>
									<div class="product-quick-view">
										<a href="javascript:void(0);" data-toggle="modal" data-target="#quick-view">quick view</a>
									</div>
					...
					<div class="row product-carousel-fullwidth cv-visible">
						...
						<div class="col-lg-3">
							<div class="product-single">
								...
								<div class="product-thumb">
									<a href="#"><img src="{{ asset('/')}}frontendAssets/images/products/shop/10.jpg" alt="" /></a>
									<div class="product-quick-view">
										<a href="javascript:void(0);" data-toggle="modal" data-target="#quick-view">quick view</a>
									</div>
								</div>
						...
						<div class="col-lg-3">
							<div class="product-single">
								...
								<div class="product-thumb">
									<a href="#"><img src="{{ asset('/')}}frontendAssets/images/products/shop/11.jpg" alt="" /></a>
									<div class="product-quick-view">
										<a href="javascript:void(0);" data-toggle="modal" data-target="#quick-view">quick view</a>
									</div>
								</div>
					...
					<div class="row product-carousel-fullwidth cv-visible">
						<div class="col-lg-3">
							<div class="product-single">
								...
								<div class="product-thumb">
									<a href="#"><img src="{{ asset('/')}}frontendAssets/images/products/15.jpg" alt="" /></a>
									<div class="downsale"><span>-</span>$25</div>
									<div class="product-quick-view">
										<a href="javascript:void(0);" data-toggle="modal" data-target="#quick-view">quick view</a>
									</div>
						...
						<div class="col-lg-3">
							<div class="product-single">
								...
								<div class="product-thumb">
									<a href="#"><img src="{{ asset('/')}}frontendAssets/images/products/16.jpg" alt="" /></a>
									<div class="product-quick-view">
										<a href="javascript:void(0);" data-toggle="modal" data-target="#quick-view">quick view</a>
									</div>
								</div>
						...
						<div class="col-lg-3">
							<div class="product-single">
								...
								<div class="product-thumb">
									<a href="#"><img src="{{ asset('/')}}frontendAssets/images/products/17.jpg" alt="" /></a>
									<div class="product-quick-view">
										<a href="javascript:void(0);" data-toggle="modal" data-target="#quick-view">quick view</a>
									</div>
								</div>
						...
						<div class="col-lg-3">
							<div class="product-single">
								...
								<div class="product-thumb">
									<a href="#"><img src="{{ asset('/')}}frontendAssets/images/products/18.jpg" alt="" /></a>
									<div class="product-quick-view">
										<a href="javascript:void(0);" data-toggle="modal" data-target="#quick-view">quick view</a>
									</div>
								</div>
						...
						<div class="col-lg-3">
							<div class="product-single">
								...
								<div class="product-thumb">
									<a href="#"><img src="{{ asset('/')}}frontendAssets/images/products/19.jpg" alt="" /></a>
									<div class="downsale"><span>-</span>$25</div>
									<div class="product-quick-view">
										<a href="javascript:void(0);" data-toggle="modal" data-target="#quick-view">quick view</a>
									</div>
						...
						<div class="col-lg-3">
							<div class="product-single">
								...
								<div class="product-thumb">
									<a href="#"><img src="{{ asset('/')}}frontendAssets/images/products/20.jpg" alt="" /></a>
									<div class="product-quick-view">
										<a href="javascript:void(0);" data-toggle="modal" data-target="#quick-view">quick view</a>
									</div>
								</div>
					...
					<div class="sidebar-single">
						...
						<div class="row blog-carousels mt-30">
							<div class="col-lg-12">
								<div class="blog-carousel">
									<div class="blog-carousel-thumb">
										<a href="#"><img src="{{ asset('/')}}frontendAssets/images/blog/sm/1.jpg" alt="" /></a>
									</div>
							...
							<div class="col-lg-12">
								<div class="blog-carousel">
									<div class="blog-carousel-thumb">
										<a href="#"><img src="{{ asset('/')}}frontendAssets/images/blog/sm/2.jpg" alt="" /></a>
									</div>
									<div class="blog-carousel-desc">
										<small>22 Apr 2019</small>
										<h4><a href="#">A blender is a kitchen and laboratory appliance</a></h4>
							...
							<div class="col-lg-12">
								<div class="blog-carousel">
									<div class="blog-carousel-thumb">
										<a href="#"><img src="{{ asset('/')}}frontendAssets/images/blog/sm/3.jpg" alt="" /></a>
									</div>
									<div class="blog-carousel-desc">
										<small>22 Apr 2019</small>
										<h4><a href="#">A blender is a kitchen and laboratory appliance</a></h4>
						...
						<div class="col-lg-4">
							...
							<div class="product-single style-2">
								<div class="row align-items-center">
									<div class="col-lg-6 p-0">
										<div class="product-thumb">
											<a href="#"><img src="{{ asset('/')}}frontendAssets/images/products/21.jpg" alt="" /></a>
										</div>
									</div>
									<div class="col-lg-6 p-0">
										<div class="product-title">
							...
							<div class="product-single style-2">
								<div class="row align-items-center">
									<div class="col-lg-6 p-0">
										<div class="product-thumb">
											<a href="#"><img src="{{ asset('/')}}frontendAssets/images/products/23.jpg" alt="" /></a>
										</div>
									</div>
									<div class="col-lg-6 p-0">
										<div class="product-title">
